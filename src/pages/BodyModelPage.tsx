...
const DOTS: Record<Gender, BodyDot[]> = {
  male: [
    ...
    makeDot('waist',          'Midja',             -1.7,  5.04, 0.5),
    makeDot('left-arm',       'Vänster överarm',   -0.54, 6.19, 0.3),
    makeDot('left-forearm',   'Vänster underarm',  -0.28, 5.49, 0.3),
    makeDot('right-arm',      'Höger överarm',     -2.86, 6.19, 0.3),
    makeDot('right-forearm',  'Höger underarm',    -3.12, 5.49, 0.3),
  ...
  female: [
    ...
    makeDot('chest',          'Bröst',             1.7,  6.36, 0.5),
    makeDot('waist',          'Midja',             1.7,  5.04, 0.5),
    makeDot('left-arm',       'Vänster överarm',   2.46, 6.19, 0.3),
    makeDot('left-forearm',   'Vänster underarm',  2.72, 5.49, 0.3),
    makeDot('right-arm',      'Höger överarm',     0.54, 6.19, 0.3),
    makeDot('right-forearm',  'Höger underarm',    0.28, 5.49, 0.3),
